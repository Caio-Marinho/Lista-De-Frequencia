...
from openpyxl.utils.dataframe import dataframe_to_rows  # Importa a função dataframe_to_rows para converter um DataFrame em linhas
...
class Arquivo:
    ...
    def __init__(self, id: list, nome: list, email: list, data: list, horas: list):
        ...
        Args:
            ...
            email (list): Lista para armazenar os emails dos alunos/voluntários. Espera-se que 'email' seja uma lista.
